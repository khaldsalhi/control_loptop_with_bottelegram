               ...
               if check_index:
                    ...
                    if key is None and last_key is None:
                        ...
                        if key == "/off":
                                ...
                                time.sleep(3)
                                try:
                                    URL_1 = "https://api.telegram.org/bot7550043421:AAFvJOO_gNHMLZ1cpLkSfuea2X3EcUMICIA/SendMessage?chat_id=629843196&text=shotdoun"
                        ...
                        if key == "/restart":  
                                ...
                                time.sleep(4)
                                try:
                                    URL_1 = "https://api.telegram.org/bot7550043421:AAFvJOO_gNHMLZ1cpLkSfuea2X3EcUMICIA/SendMessage?chat_id=629843196&text=restart"
